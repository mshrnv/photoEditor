...
* [ ] Связать функции наложения фильтров с нажатием на соответсвующие кнопки
...
* [ ] Реализовать наложение фильтра Сепия
...
* [ ] Реализовать наложение фильтра Негатив
...
* [ ] Реализовать наложение фильтра ЧБ
